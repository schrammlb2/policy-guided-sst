...
from HER.rl_modules.sac_models import actor, critic, dual_critic, tdm_critic
...
class ddpg_agent:
    def __init__(self, args, env, env_params):
        ...
        # her sampler
        self.vec_reward_func = lambda o, g, x=None: -np.abs(o-g)*20
    ...
    def _update_network(self):
        ...
        real_q = self.critic_network(inputs_norm_tensor, actions_tensor, vec=True)
