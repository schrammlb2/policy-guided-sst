...
# mpirun -np 6 python -u train_HER.py --env-name='FetchPickAndPlace' --n-epochs=100
mpirun -np 6 python -u train_HER.py --env-name='FetchPickAndPlace' --n-epochs=100 --p2p
