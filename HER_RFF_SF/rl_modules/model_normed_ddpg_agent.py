...
from HER.rl_modules.normalized_models import actor, critic
    ...
    def learn(self):
        ...
        for epoch in range(self.args.n_epochs):
            for _ in range(self.args.n_cycles):
                ...
                # self.actor_network._update_normalizer([mb_obs, mb_ag, mb_g, mb_actions], self.her_module, self._preproc_og)
                # self.critic_network._update_normalizer([mb_obs, mb_ag, mb_g, mb_actions], self.her_module, self._preproc_og)
